...
public enum BacksideFlip: Equatable, Identifiable {
    /// The backside will always appears upright when flipped.
    case automatic
    ...
    func axis(rotationAxis: (x: CGFloat, y: CGFloat, z: CGFloat)) -> (x: CGFloat, y: CGFloat, z: CGFloat) {
        switch self {
        case .automatic: rotationAxis.x > rotationAxis.y ? (1, 0, 0) : (0, 1, 0)
